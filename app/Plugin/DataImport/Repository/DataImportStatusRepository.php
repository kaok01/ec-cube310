...
/**
 * Class DataImportStatusRepository
 * @package Plugin\DataImport\Repository
 */
class DataImportStatusRepository extends EntityRepository
{
    // ポイントのステータス
    ...
    public function selectOrderIdsWithUnfixedByCustomer($customer_id)
    {
        ...
        $qb = $this->createQueryBuilder('p')
            ...
            ->setParameter('status', DataImportStatusRepository::POINT_STATUS_UNFIX)
    ...
    public function selectOrderIdsWithFixedByCustomer($customer_id)
    {
        ...
        $qb = $this->createQueryBuilder('p')
            ...
            ->andWhere('p.del_flg = :del_flg')
            ->setParameter('customer_id', $customer_id)
            ->setParameter('status', DataImportStatusRepository::POINT_STATUS_FIX)
            ->setParameter('del_flg', 0);
    ...
    public function isFixedStatus($order)
    {
        ...
        try {
            ...
            return ($result->getStatus() == DataImportStatusRepository::POINT_STATUS_FIX);
    ...
    {
        return DataImportStatusRepository::POINT_STATUS_FIX;
    }
}
