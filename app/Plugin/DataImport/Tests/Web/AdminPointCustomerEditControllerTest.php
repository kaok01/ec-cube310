...
class AdminDataImportCustomerEditControllerTest extends AbstractAdminWebTestCase
{
    protected $Customer;
    ...
    protected function createFormData($currentDataImport = 0)
    {
        $faker = $this->getFaker();
        ...
        $form = array(
            ...
            'job' => 1,
            'status' => 1,
            'plg_dataimport_current' => $currentDataImport,
            '_token' => 'dummy'
        );
        return $form;
    }
    ...
    public function testIndexWithPost()
    {
        ...
        $form = $this->createFormData($currentDataImport);
