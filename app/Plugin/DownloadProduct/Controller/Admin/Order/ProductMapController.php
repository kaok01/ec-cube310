...
class ProductMapController extends AbstractController
{
    ...
    public function index(Application $app, Request $request)
    {
        ...
        $pagination = $app['eccube.plugin.downloadproduct.repository.productmap_product']->findList();

        return $app->render('DownloadProduct/Resource/template/admin/ProductMap/index.twig', array(
    ...
    {
        $builder = $app['form.factory']->createBuilder('admin_downloadproduct_productmap');
        $form = $builder->getForm();

        $service = $app['eccube.plugin.downloadproduct.service.productmap'];
        ...
        if ('POST' === $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $app->redirect($app->url('admin_downloadproduct_productmap_list'));
            }
    ...
    public function edit(Application $app, Request $request, $id)
    {
        ...
        // IDからおすすめ商品情報を取得する
        $Recommend = $app['eccube.plugin.downloadproduct.repository.productmap_product']->findById($id);
        ...
        $form = $app['form.factory']
            ->createBuilder('admin_downloadproduct_productmap', $Recommend)
            ->getForm();
    ...
    protected function renderRegistView($app, $parameters = array())
    {
        ...
        return $app->render('DownloadProduct/Resource/template/admin/ProductMap/regist.twig', $viewParameters);
    }
