...
namespace Plugin\DownloadProduct\Controller\Admin\Customer;
...
class CsvImportController extends \Plugin\DownloadProduct\Controller\Base\CsvImportController
{
    ...
    private $customerTwig = 'DownloadProduct/Resource/template/admin/Customer/csv_customer.twig';
        ...
        if ('POST' === $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                if (!empty($formFile)) {
                    ...
                    foreach ($data as $row) {
                        ...
                        if ($id == '') {
                            ...
                            if ($refid == '') {
                                ...
                                $DownloadProductCustomer = $app['eccube.plugin.downloadproduct.repository.downloadproductcustomer']
                                    ->find($refid);
                                if ($DownloadProductCustomer) {
                                    $id = $DownloadProductCustomer->getCustomer()->getId();
                                    $makecustomer=false;
                                }else{
                                    //
                                }
                        ...
                        if ($refid == '') {
                            ...
                            if (!$DownloadProductCustomer) {
                                ...
                                $this->em->persist($DownloadProductCustomer);
                    ...
                    $app->addSuccess('admin.downloadproduct.customer.csv_import.save.complete', 'admin');
                }
